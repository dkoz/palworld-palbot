...
from utils.palgame import get_palgame_settings, update_palgame_settings
...
class PalGameSettingsCog(commands.Cog):
    ...
    @nextcord.slash_command(name="palgame", description="Manage PalGame settings")
    async def palgame(self, interaction: nextcord.Interaction):
        pass

    @palgame.subcommand(name="settings", description="Edit the PalGame settings")
