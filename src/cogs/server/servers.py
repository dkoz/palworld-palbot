...
from src.utils.modals import AddServerModal
...
class ServerConfigCog(commands.Cog):
    ...
    @nextcord.slash_command(name="editserver", description=t("ServerConfig", "editserver.description"), default_member_permissions=nextcord.Permissions(administrator=True))
    @restrict_command()
